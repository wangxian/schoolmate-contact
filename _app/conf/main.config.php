...
(
	...
	'assets_dir'		=> '',		  #资源目录位置，如/assets，存放资源文件的目录(域名后的资源文件夹名)，最后不带 ‘/’
	
//	'tpl_success'		=> 'success.tpl.html',	#show_success()用的模板文件,如：success.tpl.html,文件放在_app/views/public/success.tpl.php.如果为空，那么使用系统默认模板。
//	'tpl_error'			=> 'error.tpl.html',	#show_error()用的模板文件,同上
